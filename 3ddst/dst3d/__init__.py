...
from .models.controlnet_normal import ControlNetNormalBae
...
def build_gen_model(name, device='cpu', **kwargs):
    ...
    elif name == 'Flux.1-dev-Controlnet-Surface-Normals/control_normalbae':
        return ControlNetNormalBae(**kwargs)
    else:
