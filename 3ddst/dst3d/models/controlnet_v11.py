...
class ControlNetv11Canny(BaseModel):
    def __init__(self, model_name='control_v11p_sd15_canny', model_path='/home/kaist/semyeong/hdd/weight/diffusion/controlnet', yaml_path='/home/kaist/semyeong/3ddst/models', save_memory=False, img_resolution=512, canny_lower=100, canny_upper=200, aperture_size=3, eta=1.0, scale=9.0, strength=1.0, guess_mode=False, device='cpu', ddim_steps=20, **kwargs):
        ...
        # Build model
        self.model = create_model(os.path.join(yaml_path, f'{self.model_name}.yaml')).cpu()
    ...
    def get_condition(self, image):
        ...
        canny_map = self.apply_canny(image, self.canny_lower, self.canny_upper, self.aperture_size)
        canny_map = HWC3(canny_map)
        detected_map = canny_map
        return detected_map

    def forward(self, image=None, image_name=None, visual_prompt=None, prompt=None, negative_prompt=None, strength=None, canny_path=None):
