...
def get_args_parser():
    ...
    parser.add_argument('--model_path', type=str, default='/home/kaist/semyeong/models/3D-DST-models/3d-dst-models.csv')
    parser.add_argument('--data_path', type=str, default='/home/kaist/semyeong/data/static/3ddst/train')
    parser.add_argument('--synsets', type=str, default=[], nargs='+')
    parser.add_argument('--workers', type=int, default=8)

    # parser.add_argument('--shapenet_path', type=str, default='/home/kaist/semyeong/data/static/shapenet/ShapeNetCore.v2')
    ...
    parser.add_argument('--objaverse_path', type=str, default='/home/kaist/semyeong/data/static/objaverse', help='If empty, will download automatically.')
    ...
    parser.add_argument('--workders', type=int, default=48)
...
def worker(params):
    ...
    command = (
        f"/home/kaist/semyeong/data/tool_library/blender-3.2.2-linux-x64/blender -b -P scripts/blender_render.py -- "
